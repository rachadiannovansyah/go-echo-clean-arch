CREATE DATABASE  IF NOT EXISTS `content_db` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `content_db`;
-- MySQL dump 10.13  Distrib 5.7.17, for macos10.12 (x86_64)
--
-- Host: localhost    Database: content_db    User: root    Password:
-- ------------------------------------------------------
...
CREATE TABLE `content_categories` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `composite` (`content_id`,`category_id`)
...
INSERT INTO `content_categories` VALUES (1,1,1),(2,1,2),(3,1,3),(4,2,1),(5,2,2),(6,2,3),(7,3,3),(8,4,3),(9,5,2),(11,6,1),(10,6,2);
