...
import (
	...
	repository "gitlab.com/content-management-services/content-service/author/repository/mysql"
)
...
func TestGetByID(t *testing.T) {
	...
	aContent, err := a.GetByID(context.TODO(), userID)
	assert.NoError(t, err)
	assert.NotNil(t, aContent)
}
