...
## Changelog
- **v1**: checkout to the [v1 branch](https://github.com/rachadiannovansyah/go-echo-clean-arch/tree/v1) <br>
...
- **v2**: checkout to the [v2 branch](https://github.com/rachadiannovansyah/go-echo-clean-arch/tree/v2) <br>
...
- **v3**: master branch <br>
  ...
  Desc: Introducing Domain package, the details can be seen on this PR [#21](https://github.com/rachadiannovansyah/go-echo-clean-arch/pull/21)
...
![golang clean architecture](https://github.com/rachadiannovansyah/go-echo-clean-arch/raw/master/clean-arch.png)
...
$ git clone https://github.com/rachadiannovansyah/go-echo-clean-arch.git
...
- All libraries listed in [`go.mod`](https://github.com/rachadiannovansyah/go-echo-clean-arch/blob/master/go.mod) 
